...
export default function BranchListView() {
  ...
  function getAllDocument() {
    ...
    axios
      .get(
        `http://ec2-54-173-125-80.compute-1.amazonaws.com:8080/nccf/branch/noida/csp`
      )
      .then((res) => {
          ...
          <Container maxWidth={settings.themeStretch ? false : 'xl'}>
            <CustomBreadcrumbs
              ...
              links={[
                ...
                { name: 'CSP', href: paths.dashboard.csp },
                { name: 'List' },
              ]}
              sx={{
                mb: { xs: 3, md: 5 },
            ...
            <Card>
              ...
              <BranchTableToolbar filters={filters} onFilters={handleFilters} roleOptions={_roles} stateOptions={stateOptions} branchOptions={branchOptions} districtOptions={districtOptions} />
