...
export default function MillerNewEditForm({ currentProduct }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    console.log('DATA', { ...data,categort:vendor?.category });
  ...
  const renderProperties = (
    <>
      {mdUp && (
        <Grid md={4}>
          <Typography variant="h6" sx={{ mb: 0.5 }}>
            {mil_dis_sub_roles === 'own_distribution_rent_mill' ? "Distributor's " : "Miller's "} Personal Info
          </Typography>
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            Additional functions and attributes...
          </Typography>
        ...
        <Card>
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            ...
            >
              <RHFTextField
                name="name"
                label={mil_dis_sub_roles === 'own_distribution_rent_mill' ? 'Distributor Name ' : 'Milling Unit Name '}
              />
              {mil_dis_sub_roles !== 'own_distribution_rent_mill' && (
                <RHFAutocomplete
                  name="milling_type"
  ...
  const addressInfo = (
    <>
      {mdUp && (
        <Grid md={4}>
          <Typography variant="h6" sx={{ mb: 0.5 }}>
            {mil_dis_sub_roles === 'own_distribution_rent_mill' ? 'Distribution ' : 'Miller '} Address
          </Typography>
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            Additional address information...
          </Typography>
