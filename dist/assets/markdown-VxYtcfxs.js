import{j as s,B as l,bW as o,p as i,C as h,S as p,m as t,bK as e,E as a,H as c}from"./index-FctwF2YG.js";import{M as r}from"./markdown-6P48DsgG.js";import{C as d}from"./component-hero-kbSvwGj9.js";import{C as n}from"./CardContent-sg0FEKFL.js";const m=`
...
`;function j(){return s.jsxs(s.Fragment,{children:[s.jsx(l,{children:s.jsx(d,{children:s.jsx(o,{heading:"Markdown",links:[{name:"Components",href:i.components},{name:"Markdown"}],moreLink:["https://www.npmjs.com/package/react-markdown"]})})}),s.jsx(h,{sx:{my:10},children:s.jsxs(p,{spacing:3,direction:{xs:"column",md:"row"},children:[s.jsxs(t,{children:[s.jsx(e,{title:"Html content",sx:{pb:3}}),s.jsx(a,{sx:{borderStyle:"dashed"}}),s.jsx(n,{children:s.jsx(r,{children:m})})]}),s.jsxs(t,{children:[s.jsx(e,{title:"Mardown content",sx:{pb:3}}),s.jsx(a,{sx:{borderStyle:"dashed"}}),s.jsx(n,{children:s.jsx(r,{children:g})})]})]})})]})}function k(){return s.jsxs(s.Fragment,{children:[s.jsx(c,{children:s.jsx("title",{children:" Components: Markdown"})}),s.jsx(j,{})]})}export{k as default};
